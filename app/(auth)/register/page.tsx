  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-zinc-50 px-4">
      <div className="w-full max-w-sm rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
        <h1 className="text-xl font-semibold text-zinc-900">Firma registrieren</h1>
        <p className="mt-1 text-sm text-zinc-500">Lege deinen KI-Workspace an.</p>

        <form action={formAction} className="mt-6 space-y-4">
          <div>
            <label className="block text-sm font-medium text-zinc-700">Firmenname</label>
            <input
              name="company"
              type="text"
              required
              placeholder="z.B. Everlast Media GmbH"
